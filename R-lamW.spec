...
Version  : 2.2.4
Release  : 21
URL      : https://cran.r-project.org/src/contrib/lamW_2.2.4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/lamW_2.2.4.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718654169
...
/usr/lib64/R/library/lamW/tinytest/test_package_metadata.R

%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/lamW/libs/lamW.so
/V4/usr/lib64/R/library/lamW/libs/lamW.so
